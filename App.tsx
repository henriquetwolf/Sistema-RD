                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                                        <div className="flex justify-between items-start mb-2">
                                            <div className="p-2 bg-teal-50 rounded-lg text-teal-600"><Database size={20} /></div>
                                        </div>
                                        <h3 className="text-3xl font-bold text-slate-800">{totalJobs}</h3>
                                        <p className="text-xs text-slate-500 font-medium">Bases Conectadas</p>
                                    </div>
                                    ...
                                    <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                                        ...
                                        <p className="text-xs text-slate-500 font-medium">Última Atualização</p>
                                    </div>
