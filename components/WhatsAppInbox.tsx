...
export const WhatsAppInbox: React.FC<WhatsAppInboxProps> = ({ onNavigateToRecord, currentAgentName }) => {
  ...
  const handleSendMessage = async (e?: React.FormEvent) => {
    ...
    // Identifica quem está enviando e assina a mensagem
