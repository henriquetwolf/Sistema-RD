      ...
      {isOpen && (
        <div className="mb-4 w-80 md:w-96 h-[500px] bg-white rounded-3xl shadow-2xl border border-slate-200 flex flex-col overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] font-bold opacity-60">IA Ativa</span>
                </div>
              </div>
            </div>
          ...
          <form onSubmit={handleSend} className="p-4 bg-white border-t border-slate-100 flex gap-2">
            ...
            />
            <button type="submit" className="bg-indigo-600 text-white p-2.5 rounded-xl hover:bg-indigo-700 transition-all active:scale-95">
              <Send size={18} />
            </button>
          </form>
        </div>
