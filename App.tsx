                    ...
                    <aside className="w-full md:w-64 flex-shrink-0">
                        <div className="bg-white rounded-2xl border border-slate-200 p-3 shadow-sm sticky top-24 flex flex-col h-full md:h-auto overflow-y-auto max-h-[85vh]">
                            <nav className="space-y-1">
                                ...
                                {canAccess('support') && <button onClick={() => setDashboardTab('support')} className={clsx("w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium", dashboardTab === 'support' ? "bg-teal-50 text-teal-700 shadow-sm" : "text-slate-600 hover:bg-slate-50")}><LifeBuoy size={18} /> Chamados</button>}
