      ...
      <section id="pricing" className="py-24 px-6 bg-slate-900 text-white overflow-hidden relative">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="bg-white rounded-[3rem] p-10 md:p-16 text-slate-900 shadow-2xl relative">
            ...
            <div className="mb-4">
              <span className="text-5xl md:text-7xl font-black tracking-tighter text-slate-900">{content.pricing.price}</span>
            </div>
            <p className="text-lg font-bold text-indigo-600 mb-10">Ou em até {content.pricing.installments}</p>
