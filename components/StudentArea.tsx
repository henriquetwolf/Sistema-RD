...
export const StudentArea: React.FC<StudentAreaProps> = ({ student, onLogout }) => {
    ...
    const loadBaseData = async () => {
        ...
        try {
            ...
            // ... (Lógica de turmas e certificados legados mantida)
    ...
    const handleToggleLessonComplete = async (lessonId: string) => {
        ...
        try {
            ...
            // Verificação de Conclusão de Curso (Certificado)
    ...
    const getCourseProgress = (courseId: string) => {
        ...
        if (!course || !courseStructure) return 0;
        // Nota: isso exigiria carregar a estrutura de todos, simplificamos para o curso atual ou 0
        return 0;
    };
                                ...
                                return (
                                    ...
                                    >
                                        <div className="h-48 relative overflow-hidden">
                                            ...
                                            {isUnlocked && (
                                                <div className="absolute top-4 right-4 bg-teal-500 text-white px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest shadow-lg">Disponível</div>
                                            )}
                                        </div>
